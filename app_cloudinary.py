...
def connect_to_sheets():
    ...
    try:
        ...
        # Устанавливаем числовой формат для столбца с суммами (столбец D)
...
def handle_text(message):
    ...
    try:
        ...
        try:
            ...
            logger.warning(f"Не удалось установить формат для ячейки D{next_row}: {e}")
...
"""
        ...
        bot.reply_to(message, error_msg, reply_mup=create_status_keyboard())
